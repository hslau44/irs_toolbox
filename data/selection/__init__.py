...
class Selection(object):
    ...
    def __call__(self,df):
        ...
        Arguments:
        df (pd.DataFrame) - specific dataframe generated by torchData.utils.filepath_dataframe()
