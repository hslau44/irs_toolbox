...
def assure_path_exists(directory,makedir=False):
    """
    To make sure the directory exist, if makedir == True, the directory will be created.
    """
...
def load_npy(df,save_dir='.',splitchar='\\',verbose=True):
    """
    load csv files and save as npy files

    Args:
        df (pandas.DataFrame):  specific dataframe generated by data.utils.filepath_dataframe()
        save_dir (str): root for saving files
        splitchar (str): '\\' or '/'
        verbose (bool)
    """
