...
def leaveOneOut_crossValidation(model,dataframe,transform,verbose=True,**kwargs):
    ...
    Args:
        model (nn.Module)
        dataframe (pandas.DataFrame):  specific dataframe generated by data.utils.filepath_dataframe()
    ...
    for test_sub in dataframe['person'].unique():
        ...
        try:
            ...
            train_loader,test_loader = data_preparation(dataframe,test_sub,transform,**kwargs)
